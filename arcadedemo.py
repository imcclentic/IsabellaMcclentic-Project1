...
#single line: arcade.draw_line(start x, start y, end x, end y, color, line width)
#multipoint lines: arcade.draw_line_strip(set of corrdinates for each line segment, color, line width)
...
#LRTB rectangle: arcade.draw_lrtb_rectangle (left, right, top, bottom, color, width)
...
#XYWH rectangle: arcade.draw_xywh_rectangle (bottom left x, bottom left y, width, height, color, width)
...
#circle: arcade.draw_circle (center x, center y, radius, color, outline)
...
#triangle: arcade.draw_triangle(1st x, 1st y, 2nd x, 2nd y, 3rd x, 3rd y, color, width)
...
#arc: arcade.draw_arc(center x, center y, width, height, color, start angle, end angle, line width)
arcade.draw_parabola_filled(900, 300, 1000, 300, arcade.color.ALMOND)
#arcade.draw_parabola(start x, start y, end x, height, color, width)
